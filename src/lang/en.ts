export const en = {
	...
	'lane.set-wip-limit': 'Set work-in-progress limit',
	...
	// Modal
	'modal.wip-limit-title': 'Set work-in-progress limit',
	'modal.wip-limit-name': 'Work-in-progress limit',
	'modal.wip-limit-desc': 'Maximum cards in this lane (0 = unlimited).',
	'modal.wip-limit-label': 'Work-in-progress limit value',
	'modal.save': 'Save',
	'modal.cancel': 'Cancel',
